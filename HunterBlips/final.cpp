...
void user_moves(CircleShape& user_blip, int user_x_speed[2], int user_y_speed[2], int& pondColl, int& treeColl, char& lastKeyPress, char& twoKeysAgo) {
